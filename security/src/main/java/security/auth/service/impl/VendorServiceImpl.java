...
public class VendorServiceImpl implements VendorService {
    ...
    @Override
    public Response registerVendor(VendorRegistrationRequest vendorRegistrationRequest, HttpServletRequest httpServletRequest, MultipartFile image) throws VendorAlreadyExistsException, PhoneNumberAlreadyInUseException {
        UserDetails userDetails = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
        if (vendorRepository.existsByEmail(userDetails.getUsername()))
        ...
        String vendorImage = saveImageToDb(image, userDetails.getUsername());
    ...
    @Override
    public Response retrieveVendorInfo() throws VendorNotFoundException {
        UserDetails userDetails = (UserDetails) SecurityContextHolder.getContext().getAuthentication().getPrincipal();
