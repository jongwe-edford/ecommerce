...
public interface VendorService {
    Response registerVendor(VendorRegistrationRequest vendorRegistrationRequest, HttpServletRequest httpServletRequest, MultipartFile image) throws VendorAlreadyExistsException, PhoneNumberAlreadyInUseException;

    Response retrieveVendorInfo() throws VendorNotFoundException;
